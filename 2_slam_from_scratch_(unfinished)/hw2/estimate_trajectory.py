...
def estimate_trajectory(data_dir, out_dir):
    trajectories = get_trajectories(data_dir)
    Trajectory.write(Dataset.get_result_poses_file(out_dir), trajectories)


# if __name__ == "__main__":
# get_trajectories("/home/evgenii-iurin/work/ITMO-3DCV/hw-2/public_tests/00_test_slam_input")
# estimate_trajectory("/home/evgenii-iurin/work/ITMO-3DCV/hw-2/public_tests/00_test_slam_input", "./")
